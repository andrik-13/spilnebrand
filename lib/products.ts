...
export const products: Product[] = [
  {
    ...
    translations: {
      ua: {
        ...
        delivery: 'Після замовлення в Telegram ми підтверджуємо розмір і колір. Доставка по Україні Новою Поштою або Укрпоштою.'
      },
      en: {
        name: 'Drift trousers',
        ...
        delivery: 'Once you order in Telegram, we confirm size and color. Delivery across Ukraine via Nova Poshta or Ukrposhta.'
      }
    }
  },
  {
    ...
    translations: {
      ua: {
        ...
        delivery: 'Замовлення оформлюється через Telegram. Ми уточнюємо колір, розмір і спосіб доставки перед відправкою.'
      },
      en: {
        name: 'Flow Zip set',
        ...
        delivery: 'Orders are placed through Telegram. We confirm color, size, and delivery details before shipping.'
      }
    }
  },
  {
    ...
    translations: {
      ua: {
        ...
        delivery: 'Після замовлення в Telegram ми підтверджуємо колір і розмір. Доставка по Україні Новою Поштою або Укрпоштою.'
      },
      en: {
        name: 'Ease tee',
        ...
        delivery: 'After ordering in Telegram, we confirm color and size. Delivery across Ukraine via Nova Poshta or Ukrposhta.'
      }
    }
  }
];
