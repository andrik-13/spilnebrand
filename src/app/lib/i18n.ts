...
export function getLocaleFromParam(value: string | undefined): Locale {
  return isLocale(value) ? value : 'ua';
}
...
export const ui = {
  ua: {
    ...
    heroSubtitle:
      'Чисті силуети, природні відтінки і речі, до яких хочеться повертатися щодня.',
    ...
    aboutTitle:
      "SPIL'NE створює м'які речі для спокійного міського ритму та щоденного комфорту.",
    aboutText:
      "Ми зосереджуємось на чистих формах, м'якому трикотажі та кольорах, які легко жити разом. Кожна річ створена так, щоб працювати окремо й у комплекті, без випадкових деталей та зайвого шуму.",
    ...
    lookbookSubtitle:
      'Монохромні образи, мʼякі фактури й силуети, які легко носити щодня.',
    ...
    orderHint: 'Напиши нам у Telegram, і ми підтвердимо замовлення та колір.',
  ...
  en: {
    ...
    heroSubtitle:
      'Clean silhouettes, tactile fabrics, and calm shades designed to stay in your wardrobe beyond one season.',
    ...
    aboutText:
      'We focus on clean shapes, substantial knitwear, and tones that live well together. Each piece is made to work both on its own and as part of a set, without visual noise.',
    aboutCta: "Why SPIL'NE",
    lookbookLabel: 'Lookbook',
    lookbookTitle: 'Pieces for home, city days, and slower moments in between.',
    lookbookSubtitle:
      'Monochrome outfits, soft texture, and silhouettes that are easy to wear every day.',
    ...
    orderHint: 'Message us in Telegram and we will confirm the order and selected color.',
